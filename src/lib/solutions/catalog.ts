...
export const SOLUTION_CATEGORIES: SolutionCategory[] = [
  ...
  { id: 'ucaas', label: 'Business phones & messaging', icon: 'messages', blurb: 'Cloud phone systems, video, chat & team collaboration' },
  { id: 'cloud', label: 'Cloud hosting & apps', icon: 'desktop', blurb: 'Servers, storage, backup & business software in the cloud' },
  { id: 'colocation', label: 'Data center space', icon: 'building', blurb: 'Rack space, power & connections in a data center' },
  { id: 'connectivity', label: 'Internet & broadband', icon: 'broadcast', blurb: 'Fiber, cable & dedicated internet for your locations' },
  { id: 'contact_center', label: 'Call center & support', icon: 'specialist', blurb: 'Customer support lines, chat, IVR & agent tools' },
  { id: 'international', label: 'International / global', icon: 'roadmap', blurb: 'Connectivity and services across countries' },
  { id: 'iot', label: 'Connected devices', icon: 'bolt', blurb: 'Sensors, trackers & device connectivity (IoT)' },
  { id: 'sdwan', label: 'Smart multi-site networking', icon: 'link', blurb: 'Connect offices reliably with intelligent routing (SD-WAN)' },
  { id: 'security', label: 'Cybersecurity', icon: 'lock', blurb: 'Protect devices, data & networks from threats' },
  { id: 'tem', label: 'Bill & expense management', icon: 'chart', blurb: 'Audit and manage phone, internet & tech bills' },
  { id: 'voice', label: 'Phone lines & calling', icon: 'mobile', blurb: 'Traditional and modern voice lines for your business' },
  { id: 'wan', label: 'Private network between sites', icon: 'broadcast', blurb: 'Secure links connecting your locations' },
  { id: 'wireless', label: 'Mobile & wireless internet', icon: 'mobile', blurb: 'Cell service, 5G backup & managed mobile plans' },
  { id: 'other', label: 'Other services', icon: 'services', blurb: 'Digital signage, monitoring, telehealth & more' },
];
